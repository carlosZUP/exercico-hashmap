...
public class PostagemService {
	...
	public void adicionarPostagem() {
		postagem.put(1, new PostagemModel("Eleven12345", "Eu amo Stranger things..."
				+ "#season3"));
		postagem.put(2, new PostagemModel("EuMESM0irene", "O JIM CARREY é INCRÍVELLLL!!!"
				+ "#E para o caso de não nos vermos mais, bom dia, boa tarde, boa noite"));
		postagem.put(3, new PostagemModel("LimonaRosA765", "EU 0DEIO DO FUNDO DA ALMA, GREYS ANATOMY"
				+ "#MedicinaDeVdd"));
	}
